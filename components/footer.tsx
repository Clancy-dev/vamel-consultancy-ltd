    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#find-us" className="text-sm hover:underline">Find Us</Link></li>
              <li><Link href="#reviews" className="text-sm hover:underline">Reviews</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 text-center">
          <p className="text-sm">&copy; {new Date().getFullYear()} Vamel Consultancy Limited. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
